...
/**
 The base class for all k1504_AboutMe_Ogunjobi_Brandee modules
 */
...
/**
 k1504_AboutMe_Ogunjobi_Brandee Platform calls this method on startup.
 */
-(void)startup;

/**
 k1504_AboutMe_Ogunjobi_Brandee Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 k1504_AboutMe_Ogunjobi_Brandee Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 k1504_AboutMe_Ogunjobi_Brandee Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 k1504_AboutMe_Ogunjobi_Brandee Platform calls this method on resume.
 @param sender The sender of the event.
 */
