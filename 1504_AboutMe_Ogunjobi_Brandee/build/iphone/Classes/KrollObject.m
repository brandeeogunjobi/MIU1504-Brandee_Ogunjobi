...
//@interface k1504_AboutMe_Ogunjobi_BrandeeObject : NSObject
//@end

@interface k1504_AboutMe_Ogunjobi_BrandeeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[k1504_AboutMe_Ogunjobi_BrandeeObject class]])
		{
			for (NSString *key in [[(k1504_AboutMe_Ogunjobi_BrandeeObject*)o modules] allKeys])
			{
