...
/**
 Base class for all k1504_AboutMe_Ogunjobi_Brandee views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the k1504_AboutMe_Ogunjobi_Brandee view hierarchy (such as wrapped iOS UIViews) was touched.
