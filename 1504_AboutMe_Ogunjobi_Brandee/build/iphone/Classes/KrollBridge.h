...
@interface k1504_AboutMe_Ogunjobi_BrandeeObject : KrollCoverageObject {
#else
@interface k1504_AboutMe_Ogunjobi_BrandeeObject : KrollObject {
#endif
@private
...
extern NSString * k1504_AboutMe_Ogunjobi_Brandee$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	k1504_AboutMe_Ogunjobi_BrandeeObject *_k1504_aboutme_ogunjobi_brandee;
    KrollObject* console;
	BOOL shutdown;
