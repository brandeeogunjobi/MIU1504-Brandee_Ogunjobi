...
// in simulator we redefine to format for k1504_AboutMe_Ogunjobi_Brandee Developer console
...
{\
	NSString * exceptionName = [@"org.k1504_aboutme_ogunjobi_brandee." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.k1504_aboutme_ogunjobi_brandee";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemNone = -1, 
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemSpinner = -2,
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemProgressBar = -3,
	
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemSlider = -4,
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemSwitch = -5,
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemMultiButton = -6,
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemSegmented = -7,
	
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemTextView = -8,
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemTextField = -9,
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemSearchBar = -10,
	
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemPicker = -11,
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemDatePicker = -12,
	
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemInfoLight = -13,
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemInfoDark = -14,
	
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemDisclosure = -15,
	
	UIk1504_AboutMe_Ogunjobi_BrandeeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all k1504_AboutMe_Ogunjobi_Brandee instances of
